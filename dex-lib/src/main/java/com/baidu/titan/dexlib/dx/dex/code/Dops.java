...
import com.baidu.titan.dexlib.dx.dex.code.form.Form10t;
import com.baidu.titan.dexlib.dx.dex.code.form.Form10x;
import com.baidu.titan.dexlib.dx.dex.code.form.Form11n;
import com.baidu.titan.dexlib.dx.dex.code.form.Form11x;
import com.baidu.titan.dexlib.dx.dex.code.form.Form12x;
import com.baidu.titan.dexlib.dx.dex.code.form.Form20t;
import com.baidu.titan.dexlib.dx.dex.code.form.Form21c;
import com.baidu.titan.dexlib.dx.dex.code.form.Form21h;
import com.baidu.titan.dexlib.dx.dex.code.form.Form21s;
import com.baidu.titan.dexlib.dx.dex.code.form.Form21t;
import com.baidu.titan.dexlib.dx.dex.code.form.Form22b;
import com.baidu.titan.dexlib.dx.dex.code.form.Form22c;
import com.baidu.titan.dexlib.dx.dex.code.form.Form22s;
import com.baidu.titan.dexlib.dx.dex.code.form.Form22t;
import com.baidu.titan.dexlib.dx.dex.code.form.Form22x;
import com.baidu.titan.dexlib.dx.dex.code.form.Form23x;
import com.baidu.titan.dexlib.dx.dex.code.form.Form30t;
import com.baidu.titan.dexlib.dx.dex.code.form.Form31c;
import com.baidu.titan.dexlib.dx.dex.code.form.Form31i;
import com.baidu.titan.dexlib.dx.dex.code.form.Form31t;
import com.baidu.titan.dexlib.dx.dex.code.form.Form32x;
import com.baidu.titan.dexlib.dx.dex.code.form.Form35c;
import com.baidu.titan.dexlib.dx.dex.code.form.Form3rc;
import com.baidu.titan.dexlib.dx.dex.code.form.Form51l;
import com.baidu.titan.dexlib.dx.dex.code.form.SpecialFormat;
import com.baidu.titan.dexlib.dx.io.Opcodes;
...
public final class Dops {
    ...
    public static final Dop NOP =
        new Dop(Opcodes.NOP, Opcodes.NOP,
            Opcodes.NO_NEXT, Form10x.THE_ONE, false).setFlags(Dop.FLAG_CFG_CONTINUE);

    public static final Dop MOVE =
        new Dop(Opcodes.MOVE, Opcodes.MOVE,
            Opcodes.MOVE_FROM16, Form12x.THE_ONE, true).setFlags(Dop.FLAG_CFG_CONTINUE);

    public static final Dop MOVE_FROM16 =
        new Dop(Opcodes.MOVE_FROM16, Opcodes.MOVE,
            Opcodes.MOVE_16, Form22x.THE_ONE, true).setFlags(Dop.FLAG_CFG_CONTINUE);

    public static final Dop MOVE_16 =
        new Dop(Opcodes.MOVE_16, Opcodes.MOVE,
            Opcodes.NO_NEXT, Form32x.THE_ONE, true).setFlags(Dop.FLAG_CFG_CONTINUE);

    public static final Dop MOVE_WIDE =
        new Dop(Opcodes.MOVE_WIDE, Opcodes.MOVE_WIDE,
            Opcodes.MOVE_WIDE_FROM16, Form12x.THE_ONE, true).setFlags(Dop.FLAG_CFG_CONTINUE);

    public static final Dop MOVE_WIDE_FROM16 =
        new Dop(Opcodes.MOVE_WIDE_FROM16, Opcodes.MOVE_WIDE,
            Opcodes.MOVE_WIDE_16, Form22x.THE_ONE, true).setFlags(Dop.FLAG_CFG_CONTINUE);
    ...
    public static final Dop MOVE_OBJECT =
        new Dop(Opcodes.MOVE_OBJECT, Opcodes.MOVE_OBJECT,
            Opcodes.MOVE_OBJECT_FROM16, Form12x.THE_ONE, true).setFlags(Dop.FLAG_CFG_CONTINUE);

    public static final Dop MOVE_OBJECT_FROM16 =
        new Dop(Opcodes.MOVE_OBJECT_FROM16, Opcodes.MOVE_OBJECT,
            Opcodes.MOVE_OBJECT_16, Form22x.THE_ONE, true).setFlags(Dop.FLAG_CFG_CONTINUE);
    ...
    public static final Dop MOVE_RESULT =
        new Dop(Opcodes.MOVE_RESULT, Opcodes.MOVE_RESULT,
            Opcodes.NO_NEXT, Form11x.THE_ONE, true).setFlags(Dop.FLAG_CFG_CONTINUE);
    ...
    public static final Dop RETURN_VOID =
        new Dop(Opcodes.RETURN_VOID, Opcodes.RETURN_VOID,
            Opcodes.NO_NEXT, Form10x.THE_ONE, false).setFlags(Dop.FLAG_CFG_RETURN);

    public static final Dop RETURN =
        new Dop(Opcodes.RETURN, Opcodes.RETURN,
            Opcodes.NO_NEXT, Form11x.THE_ONE, false).setFlags(Dop.FLAG_CFG_RETURN);
    ...
    public static final Dop CONST_4 =
        new Dop(Opcodes.CONST_4, Opcodes.CONST,
            Opcodes.CONST_16, Form11n.THE_ONE, true).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_CONST);

    public static final Dop CONST_16 =
        new Dop(Opcodes.CONST_16, Opcodes.CONST,
            Opcodes.CONST_HIGH16, Form21s.THE_ONE, true).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_CONST);

    public static final Dop CONST =
        new Dop(Opcodes.CONST, Opcodes.CONST,
            Opcodes.NO_NEXT, Form31i.THE_ONE, true).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_CONST);

    public static final Dop CONST_HIGH16 =
        new Dop(Opcodes.CONST_HIGH16, Opcodes.CONST,
            Opcodes.CONST, Form21h.THE_ONE, true).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_CONST);

    public static final Dop CONST_WIDE_16 =
        new Dop(Opcodes.CONST_WIDE_16, Opcodes.CONST_WIDE,
            Opcodes.CONST_WIDE_HIGH16, Form21s.THE_ONE, true).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_CONST);

    public static final Dop CONST_WIDE_32 =
        new Dop(Opcodes.CONST_WIDE_32, Opcodes.CONST_WIDE,
            Opcodes.CONST_WIDE, Form31i.THE_ONE, true).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_CONST);

    public static final Dop CONST_WIDE =
        new Dop(Opcodes.CONST_WIDE, Opcodes.CONST_WIDE,
            Opcodes.NO_NEXT, Form51l.THE_ONE, true).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_CONST);

    public static final Dop CONST_WIDE_HIGH16 =
        new Dop(Opcodes.CONST_WIDE_HIGH16, Opcodes.CONST_WIDE,
            Opcodes.CONST_WIDE_32, Form21h.THE_ONE, true).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_CONST);

    public static final Dop CONST_STRING =
        new Dop(Opcodes.CONST_STRING, Opcodes.CONST_STRING,
            Opcodes.CONST_STRING_JUMBO, Form21c.THE_ONE, true).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_THROW | Dop.FLAG_CFG_CONST);

    public static final Dop CONST_STRING_JUMBO =
        new Dop(Opcodes.CONST_STRING_JUMBO, Opcodes.CONST_STRING,
            Opcodes.NO_NEXT, Form31c.THE_ONE, true).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_THROW | Dop.FLAG_CFG_CONST);

    public static final Dop CONST_CLASS =
        new Dop(Opcodes.CONST_CLASS, Opcodes.CONST_CLASS,
            Opcodes.NO_NEXT, Form21c.THE_ONE, true).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_THROW | Dop.FLAG_CFG_CONST);

    public static final Dop MONITOR_ENTER =
        new Dop(Opcodes.MONITOR_ENTER, Opcodes.MONITOR_ENTER,
            Opcodes.NO_NEXT, Form11x.THE_ONE, false).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_THROW);
    ...
    public static final Dop INSTANCE_OF =
        new Dop(Opcodes.INSTANCE_OF, Opcodes.INSTANCE_OF,
            Opcodes.NO_NEXT, Form22c.THE_ONE, true).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_THROW | Dop.FLAG_CFG_CONST);

    public static final Dop ARRAY_LENGTH =
        new Dop(Opcodes.ARRAY_LENGTH, Opcodes.ARRAY_LENGTH,
            Opcodes.NO_NEXT, Form12x.THE_ONE, true).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_THROW);
    ...
    public static final Dop FILLED_NEW_ARRAY =
        new Dop(Opcodes.FILLED_NEW_ARRAY, Opcodes.FILLED_NEW_ARRAY,
            Opcodes.FILLED_NEW_ARRAY_RANGE, Form35c.THE_ONE, false).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_THROW | Dop.FLAG_CFG_CONST);

    public static final Dop FILLED_NEW_ARRAY_RANGE =
        new Dop(Opcodes.FILLED_NEW_ARRAY_RANGE, Opcodes.FILLED_NEW_ARRAY,
            Opcodes.NO_NEXT, Form3rc.THE_ONE, false).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_THROW | Dop.FLAG_CFG_CONST);

    public static final Dop FILL_ARRAY_DATA =
        new Dop(Opcodes.FILL_ARRAY_DATA, Opcodes.FILL_ARRAY_DATA,
            Opcodes.NO_NEXT, Form31t.THE_ONE, false).setFlags(Dop.FLAG_CFG_CONTINUE);

    public static final Dop THROW =
        new Dop(Opcodes.THROW, Opcodes.THROW,
            Opcodes.NO_NEXT, Form11x.THE_ONE, false).setFlags(Dop.FLAG_CFG_THROW);

    public static final Dop GOTO =
        new Dop(Opcodes.GOTO, Opcodes.GOTO,
            Opcodes.GOTO_16, Form10t.THE_ONE, false).setFlags(Dop.FLAG_CFG_BRANCH);

    public static final Dop GOTO_16 =
        new Dop(Opcodes.GOTO_16, Opcodes.GOTO,
            Opcodes.GOTO_32, Form20t.THE_ONE, false).setFlags(Dop.FLAG_CFG_BRANCH);

    public static final Dop GOTO_32 =
        new Dop(Opcodes.GOTO_32, Opcodes.GOTO,
            Opcodes.NO_NEXT, Form30t.THE_ONE, false).setFlags(Dop.FLAG_CFG_BRANCH);

    public static final Dop PACKED_SWITCH =
        new Dop(Opcodes.PACKED_SWITCH, Opcodes.PACKED_SWITCH,
            Opcodes.NO_NEXT, Form31t.THE_ONE, false).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_SWITCH);
    ...
    public static final Dop CMPL_FLOAT =
        new Dop(Opcodes.CMPL_FLOAT, Opcodes.CMPL_FLOAT,
            Opcodes.NO_NEXT, Form23x.THE_ONE, true).setFlags(Dop.FLAG_CFG_CONTINUE);
    ...
    public static final Dop IF_EQ =
        new Dop(Opcodes.IF_EQ, Opcodes.IF_EQ,
            Opcodes.NO_NEXT, Form22t.THE_ONE, false).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_BRANCH);
    ...
    public static final Dop IF_EQZ =
        new Dop(Opcodes.IF_EQZ, Opcodes.IF_EQZ,
            Opcodes.NO_NEXT, Form21t.THE_ONE, false).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_BRANCH);
    ...
    public static final Dop AGET =
        new Dop(Opcodes.AGET, Opcodes.AGET,
            Opcodes.NO_NEXT, Form23x.THE_ONE, true).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_THROW);
    ...
    public static final Dop APUT =
        new Dop(Opcodes.APUT, Opcodes.APUT,
            Opcodes.NO_NEXT, Form23x.THE_ONE, false).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_THROW);
    ...
    public static final Dop IPUT =
        new Dop(Opcodes.IPUT, Opcodes.IPUT,
            Opcodes.NO_NEXT, Form22c.THE_ONE, false).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_THROW | Dop.FLAG_CFG_CONST);
    ...
    public static final Dop SPUT =
        new Dop(Opcodes.SPUT, Opcodes.SPUT,
            Opcodes.NO_NEXT, Form21c.THE_ONE, false).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_THROW | Dop.FLAG_CFG_CONST);
    ...
    public static final Dop INVOKE_VIRTUAL =
        new Dop(Opcodes.INVOKE_VIRTUAL, Opcodes.INVOKE_VIRTUAL,
            Opcodes.INVOKE_VIRTUAL_RANGE, Form35c.THE_ONE, false).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_THROW | Dop.FLAG_CFG_INVOKE | Dop.FLAG_CFG_CONST);

    public static final Dop INVOKE_SUPER =
        new Dop(Opcodes.INVOKE_SUPER, Opcodes.INVOKE_SUPER,
            Opcodes.INVOKE_SUPER_RANGE, Form35c.THE_ONE, false).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_THROW | Dop.FLAG_CFG_INVOKE | Dop.FLAG_CFG_CONST);

    public static final Dop INVOKE_DIRECT =
        new Dop(Opcodes.INVOKE_DIRECT, Opcodes.INVOKE_DIRECT,
            Opcodes.INVOKE_DIRECT_RANGE, Form35c.THE_ONE, false).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_THROW | Dop.FLAG_CFG_INVOKE | Dop.FLAG_CFG_CONST);

    public static final Dop INVOKE_STATIC =
        new Dop(Opcodes.INVOKE_STATIC, Opcodes.INVOKE_STATIC,
            Opcodes.INVOKE_STATIC_RANGE, Form35c.THE_ONE, false).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_THROW | Dop.FLAG_CFG_INVOKE | Dop.FLAG_CFG_CONST);

    public static final Dop INVOKE_INTERFACE =
        new Dop(Opcodes.INVOKE_INTERFACE, Opcodes.INVOKE_INTERFACE,
            Opcodes.INVOKE_INTERFACE_RANGE, Form35c.THE_ONE, false).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_THROW | Dop.FLAG_CFG_INVOKE | Dop.FLAG_CFG_CONST);

    public static final Dop INVOKE_VIRTUAL_RANGE =
        new Dop(Opcodes.INVOKE_VIRTUAL_RANGE, Opcodes.INVOKE_VIRTUAL,
            Opcodes.NO_NEXT, Form3rc.THE_ONE, false).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_THROW | Dop.FLAG_CFG_INVOKE | Dop.FLAG_CFG_CONST);
    ...
    public static final Dop NEG_INT =
        new Dop(Opcodes.NEG_INT, Opcodes.NEG_INT,
            Opcodes.NO_NEXT, Form12x.THE_ONE, true).setFlags(Dop.FLAG_CFG_CONTINUE);
    ...
    public static final Dop DIV_INT_LIT16 =
        new Dop(Opcodes.DIV_INT_LIT16, Opcodes.DIV_INT,
            Opcodes.NO_NEXT, Form22s.THE_ONE, true).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_THROW | Dop.FLAG_CFG_CONST);
    ...
    public static final Dop ADD_INT_LIT8 =
        new Dop(Opcodes.ADD_INT_LIT8, Opcodes.ADD_INT,
            Opcodes.ADD_INT_LIT16, Form22b.THE_ONE, true).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_CONST);

    public static final Dop RSUB_INT_LIT8 =
        new Dop(Opcodes.RSUB_INT_LIT8, Opcodes.RSUB_INT,
            Opcodes.RSUB_INT, Form22b.THE_ONE, true).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_CONST);

    public static final Dop MUL_INT_LIT8 =
        new Dop(Opcodes.MUL_INT_LIT8, Opcodes.MUL_INT,
            Opcodes.MUL_INT_LIT16, Form22b.THE_ONE, true).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_CONST);

    public static final Dop DIV_INT_LIT8 =
        new Dop(Opcodes.DIV_INT_LIT8, Opcodes.DIV_INT,
            Opcodes.DIV_INT_LIT16, Form22b.THE_ONE, true).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_THROW | Dop.FLAG_CFG_CONST);

    public static final Dop REM_INT_LIT8 =
        new Dop(Opcodes.REM_INT_LIT8, Opcodes.REM_INT,
            Opcodes.REM_INT_LIT16, Form22b.THE_ONE, true).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_THROW | Dop.FLAG_CFG_CONST);

    public static final Dop AND_INT_LIT8 =
        new Dop(Opcodes.AND_INT_LIT8, Opcodes.AND_INT,
            Opcodes.AND_INT_LIT16, Form22b.THE_ONE, true).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_CONST);

    public static final Dop OR_INT_LIT8 =
        new Dop(Opcodes.OR_INT_LIT8, Opcodes.OR_INT,
            Opcodes.OR_INT_LIT16, Form22b.THE_ONE, true).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_CONST);

    public static final Dop XOR_INT_LIT8 =
        new Dop(Opcodes.XOR_INT_LIT8, Opcodes.XOR_INT,
            Opcodes.XOR_INT_LIT16, Form22b.THE_ONE, true).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_CONST);

    public static final Dop SHL_INT_LIT8 =
        new Dop(Opcodes.SHL_INT_LIT8, Opcodes.SHL_INT,
            Opcodes.NO_NEXT, Form22b.THE_ONE, true).setFlags(Dop.FLAG_CFG_CONTINUE | Dop.FLAG_CFG_CONST);
