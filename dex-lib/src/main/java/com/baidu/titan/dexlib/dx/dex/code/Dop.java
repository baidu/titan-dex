...
import com.baidu.titan.dexlib.dx.io.OpcodeInfo;
...
public final class Dop {
    ...
    static final int FLAG_CFG_CONTINUE = 1 << 0;
    static final int FLAG_CFG_RETURN = 1 << 1;
    static final int FLAG_CFG_THROW = 1 << 2;
    static final int FLAG_CFG_BRANCH = 1 << 3;
    static final int FLAG_CFG_INVOKE = 1 << 4;
    static final int FLAG_CFG_SWITCH = 1 << 5;
    static final int FLAG_CFG_CONST = 1 << 6;
    ...
    public Dop setFlags(int flags) {
        this.flags = flags;
        return this;
    }

    public boolean ableContinue() {
        return (this.flags & FLAG_CFG_CONTINUE) != 0;
    }

    public boolean ableBranch() {
        return (this.flags & FLAG_CFG_BRANCH) != 0;
    }

    public boolean ableSwitch() {
        return (this.flags & FLAG_CFG_SWITCH) != 0;
    }

    public boolean constOp() {
        return (this.flags & FLAG_CFG_CONST) != 0;
    }
