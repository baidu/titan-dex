...
package com.baidu.titan.dexlib.dx.command.dexer;

import com.baidu.titan.dexlib.dex.Dex;
import com.baidu.titan.dexlib.dex.DexException;
import com.baidu.titan.dexlib.dex.DexFormat;
import com.baidu.titan.dexlib.dex.util.FileUtils;
import com.baidu.titan.dexlib.dx.Version;
import com.baidu.titan.dexlib.dx.cf.code.SimException;
import com.baidu.titan.dexlib.dx.cf.direct.ClassPathOpener;
import com.baidu.titan.dexlib.dx.cf.direct.DirectClassFile;
import com.baidu.titan.dexlib.dx.cf.direct.StdAttributeFactory;
import com.baidu.titan.dexlib.dx.cf.iface.ParseException;
import com.baidu.titan.dexlib.dx.command.DxConsole;
import com.baidu.titan.dexlib.dx.command.UsageException;
import com.baidu.titan.dexlib.dx.dex.DexOptions;
import com.baidu.titan.dexlib.dx.dex.cf.CfOptions;
import com.baidu.titan.dexlib.dx.dex.cf.CfTranslator;
import com.baidu.titan.dexlib.dx.dex.cf.CodeStatistics;
...
import com.baidu.titan.dexlib.dx.merge.CollisionPolicy;
import com.baidu.titan.dexlib.dx.merge.DexMerger;
...
public class Main {
    ...
    public static void main(String[] argArray) throws IOException {
        ...
        File baseDir = new File("dex-s");

        //ArrayList<String> inputs = new ArrayList<>();
        // inputs.add(new File("class.class").getAbsolutePath());
        // arguments.inputList = inputs;
        //System.out.println(new File("class.class").getAbsolutePath());
        arguments.fileNames = new String[] {new File(baseDir, "org-dex").getAbsolutePath()};
        System.out.println(Arrays.toString(arguments.fileNames));
        arguments.outName = new File(baseDir, "dex.jar").getAbsolutePath();
