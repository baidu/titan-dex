...
public final class ArrayData extends VariableSizeInsn {
    ...
    public ArrayData(SourcePosition position, CodeAddress user, int elemWidth, int initLength, byte[] data) {
...
//        }
    ...
    public DalvInsn withRegisters(RegisterSpecList registers) {
        return new ArrayData(getPosition(), user, elemWidth, initLength, mData);
    }
