...
package com.baidu.titan.dexlib.dx.command;
    ...
    public static void main(String[] args) {
        ...
        try {
            for (int i = 0; i < args.length; i++) {
                ...
                gotCmd = true;
                if (arg.equals("--dex")) {
                    com.baidu.titan.dexlib.dx.command.dexer.Main.main(without(args, i));
                    break;
                } else if (arg.equals("--dump")) {
                    com.baidu.titan.dexlib.dx.command.dump.Main.main(without(args, i));
                    break;
                } else if (arg.equals("--annotool")) {
                    com.baidu.titan.dexlib.dx.command.annotool.Main.main(
                            without(args, i));
                    break;
                } else if (arg.equals("--find-usages")) {
                    com.baidu.titan.dexlib.dx.command.findusages.Main.main(without(args, i));
                    break;
