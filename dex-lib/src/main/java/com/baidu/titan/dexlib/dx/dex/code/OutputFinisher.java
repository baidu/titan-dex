...
import com.baidu.titan.dexlib.dx.rop.cst.CstMemberRef;
...
public final class OutputFinisher {
    ...
    private static void assignIndices(CstInsn insn,
        ...
        if (cst instanceof CstLiteral32) {
            CstLiteral32 cst32 = (CstLiteral32) cst;
            if ((cst32.getTransformFlags() & CstLiteral32.TRANSFORM_FLAG_METHODID) != 0) {
                cst32.reAssignValue(callback.getCurrentMethodId());
            } else if ((cst32.getTransformFlags() & CstLiteral32.TRANSFORM_FLAG_CLASSID) != 0) {
                cst32.reAssignValue(callback.getCurrentClassId());
            }
        }
